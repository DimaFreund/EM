...
SpiderMag theme is translation ready.


== License ==

SpiderMag is based on Underscores http://underscores.me/, (C) 2012-2014 Automattic, Inc.
...
SpiderMag WordPress Theme, Copyright 2016 SparklewpThemes
SpiderMag is distributed under the terms of the GNU General Public License v3
...
Licensed under MIT (http://www.owlgraphic.com/owlcarousel/)
...
Images
    ...
    https://pixabay.com/en/rodeo-horse-white-horse-action-shot-1010051/ License CC0 Public Domain
    https://pixabay.com/en/horse-race-hippodrome-horses-1665688/ License CC0 Public Domain
    https://pixabay.com/en/high-jump-track-field-competition-695308/ License CC0 Public Domain
    https://pixabay.com/en/soccer-ball-football-players-game-263716/ License CC0 Public Domain
    https://pixabay.com/en/man-fan-person-football-soccer-290186/ License CC0 Public Domain
    https://www.pexels.com/photo/woman-wearing-purple-tank-top-holding-purple-and-white-racket-and-lawn-tennis-ball-34703/
	https://pixabay.com/en/surfing-surf-surfboard-courage-817962/  License CC0 Public Domain
	https://www.pexels.com/photo/man-beach-holiday-vacation-33046/ License CC0 Public Domain
	https://www.pexels.com/photo/black-and-white-nascar-car-39619/ License CC0 Public Domain
...
= 1.0.8 3rd September 2017 =

** Fixed the mistake spelling of welcom landing page text.
** Updated .pot file.

= 1.0.7 19th August 2017 =

** Fixed the header responsive issue
** Fixed the main menu design and responsive mobile view issue.
** Fixed the overlay color issue.


= 1.0.6 10th August 2017 =

** Fixed the homepage right, left and full widht layout options.
** Fixed the search both sidebar design issue.
** Fixed the custom java scripts issue.
** Add the Upgreage PRO version button link and information.

= 1.0.5 =

** Make theme compatible with woocommerce, Contact Form 7, AccessPress Social Share, AccessPress Social Counter.
** Add suggest wordpress plugin function.
** Fixed the simple design issue.
